...
if input1 == 1:  # If the user chooses Celsius
        ...
        print("The temperature in Fahrenheit is " + str(temp2) + ",this was found by using the formula of 'F = (C * 9/5) + 32' ")  # Output of the temperature in Fahrenheit
        print("The temperature in Kelvin is " + str(temp3) + ",this was found by using the formula of 'K = C + 273.15'")  # Output of the temperature in Kelvin
        ...
        print("The temperature in Celsius is " + str(temp2) + ",this was found by using the formula of 'C = (F-32) * 5/9'")  # Output of the temperature in Celsius
        print("The temperature in Kelvin is " + str(temp3) + ",this was found using the formula of 'K = C + 273.15'")  # Output of the temperature in Kelvin
        ...
        print("The temperature in Celsius is " + str(temp2) + ", this was found using the formula of 'C = K - 273.15'")  # Output of the temperature in Celsius
        print("The temperature in Fahrenheit is " + str(temp3) + ", this was found by using the formula of 'F = C * 9/5 + 32'")  # Output of the temperature in Fahrenheit
